...
export function addCandidate(state: IntakeState, input: { name: string; url: string; notes: string; source?:CandidateSource; region?:string; category?:string; evidence?:string[] }, id: string, at: string, actor = 'Aprovador · controlado'): IntakeState {
